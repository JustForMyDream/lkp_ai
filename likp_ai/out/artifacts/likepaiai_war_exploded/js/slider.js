var IMGSRCP = ['shouye', 'dingdan', 'xiangce', 'yingji', 'xiaoxi', 'geren', 'shoucang'];
//var IMGSRC = ['shouye1','dingdan1','xiangce1','yingji@31','xiaoxi1','wode1','heart'];
var TITLE = ['首页', '订单', '相册', '影集', '消息', '个人资料', '我的收藏'];
var ID = ['index', 'ordercenter', 'albumlist', ' YingjiList', 'messagecenter', 'gerenziliao', 'collectionlist'];
