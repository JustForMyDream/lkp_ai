 ...
 */
@Entity
@javax.persistence.Table(name = "tlk_yingjipic", schema = "lkp", catalog = "")
@Access(AccessType.PROPERTY)
public class TlkYingjipicEntity {
/*    private String parent;
    ...
    private TlkYingjiEntity tlkYingjiEntity;

    @ManyToOne
    @JoinColumn(name = "PARENT",foreignKey = @ForeignKey(name = "null"))
    public TlkYingjiEntity getTlkYingjiEntity() {
        return tlkYingjiEntity;
    }

    public void setTlkYingjiEntity(TlkYingjiEntity tlkYingjiEntity) {
        this.tlkYingjiEntity = tlkYingjiEntity;
    }
    ...
    private String formname = "lkp/社区产品/订单管理/Yingjipic";
    ...
    private String formid = "11e6-9591-fe448a46-ad8b-11472dfbd6fd";
    ...
    @Basic
    @javax.persistence.Column(name = "ITEM_IMGURL", nullable = true, length = 200)
    ...
    @Basic
    @javax.persistence.Column(name = "ITEM_DESCRIPTION", nullable = true, length = 200)
    ...
    @Basic
    @javax.persistence.Column(name = "ITEM_ORDER", nullable = true, length = 200)
    ...
    public boolean equals(Object o) {
        ...
        TlkYingjipicEntity that = (TlkYingjipicEntity) o;
        ...
        if (prevaudituser != null ? !prevaudituser.equals(that.prevaudituser) : that.prevaudituser != null)
            return false;
        if (itemImgurl != null ? !itemImgurl.equals(that.itemImgurl) : that.itemImgurl != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemImgurl != null ? itemImgurl.hashCode() : 0);
