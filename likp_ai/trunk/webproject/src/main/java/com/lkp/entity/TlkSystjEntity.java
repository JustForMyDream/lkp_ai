 ...
 */
@Entity
@Table(name = "tlk_systj", schema = "lkp", catalog = "")
public class TlkSystjEntity {
    ...
    public boolean equals(Object o) {
        ...
        TlkSystjEntity that = (TlkSystjEntity) o;
        ...
        if (itemPxxh != null ? !itemPxxh.equals(that.itemPxxh) : that.itemPxxh != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemPxxh != null ? itemPxxh.hashCode() : 0);
