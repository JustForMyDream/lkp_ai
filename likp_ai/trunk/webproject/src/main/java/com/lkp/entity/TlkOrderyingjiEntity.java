 ...
 */
@Entity
@Table(name = "tlk_orderyingji", schema = "lkp", catalog = "")
public class TlkOrderyingjiEntity {
    private String parent;
    private Date lastmodified = new Date();
    private String formname = "lkp/社区产品/订单管理/orderyingji";
    ...
    private String formid = "11e6-9593-1356de60-ad8b-11472dfbd6fd";
    ...
    @Basic
    @Column(name = "ITEM_YINGJIID")
    public String getItemYingjiid() {
        return itemYingjiid;
    }

    public void setItemYingjiid(String itemYingjiid) {
        this.itemYingjiid = itemYingjiid;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkOrderyingjiEntity that = (TlkOrderyingjiEntity) o;
        ...
        if (itemYingjiid != null ? !itemYingjiid.equals(that.itemYingjiid) : that.itemYingjiid != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemYingjiid != null ? itemYingjiid.hashCode() : 0);
