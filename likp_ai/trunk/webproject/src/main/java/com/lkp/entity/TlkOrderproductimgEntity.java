 ...
 */
@Entity
@Table(name = "tlk_orderproductimg", schema = "lkp", catalog = "")
public class TlkOrderproductimgEntity {
    private String parent;
    private Date lastmodified = new Date();
    private String formname = "lkp/社区产品/订单管理/orderproductimg";
    ...
    private String formid = "11e6-9508-6937f2bb-ad8b-11472dfbd6fd";
    ...
    public boolean equals(Object o) {
        ...
        TlkOrderproductimgEntity that = (TlkOrderproductimgEntity) o;
    ...
    @Basic
    @Column(name = "ITEM_TPLX")
    public String getItemTplx() {
        return itemTplx;
    }

    public void setItemTplx(String itemTplx) {
        this.itemTplx = itemTplx;
    }
}
