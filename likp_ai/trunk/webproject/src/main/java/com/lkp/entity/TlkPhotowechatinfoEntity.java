 ...
 */
@Entity
@javax.persistence.Table(name = "tlk_photowechatinfo", schema = "lkp", catalog = "")
@Access(AccessType.PROPERTY)
public class TlkPhotowechatinfoEntity {
    ...
    private String formname = "lkp/社区产品/用户管理/photowechatinfo";
    ...
    private String formid = "11e6-9465-799515f0-ad8b-11472dfbd6fd";
    ...
    /*private String itemPhoneid;

    @Basic
    @javax.persistence.Column(name = "ITEM_PHONEID", nullable = true, length = 200)
    public String getItemPhoneid() {
        return itemPhoneid;
    }

    public void setItemPhoneid(String itemPhoneid) {
        this.itemPhoneid = itemPhoneid;
    }*/

    private TlkPhotographerEntity tlkPhotographerEntity;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ITEM_PHONEID",foreignKey = @ForeignKey(name = "null"))
    public TlkPhotographerEntity getTlkPhotographerEntity() {
        return tlkPhotographerEntity;
    }

    public void setTlkPhotographerEntity(TlkPhotographerEntity tlkPhotographerEntity) {
        this.tlkPhotographerEntity = tlkPhotographerEntity;
    }
    ...
    private TlkWechatuserEntity tlkWechatuserEntity;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ITEM_OPENID",foreignKey = @ForeignKey(name = "null"))
    public TlkWechatuserEntity getTlkWechatuserEntity() {
        return tlkWechatuserEntity;
    }

    public void setTlkWechatuserEntity(TlkWechatuserEntity tlkWechatuserEntity) {
        this.tlkWechatuserEntity = tlkWechatuserEntity;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkPhotowechatinfoEntity that = (TlkPhotowechatinfoEntity) o;
