 ...
 */
@Entity
@Table(name = "tlk_fwz", schema = "lkp", catalog = "")
public class TlkFwzEntity {
    private String parent;
    private Date lastmodified = new Date();
    private String formname = "lkp/社区产品/首页管理/FWZ";
    ...
    public boolean equals(Object o) {
        ...
        TlkFwzEntity that = (TlkFwzEntity) o;
    ...
    @Basic
    @Column(name = "ITEM_XXDZ")
    public String getItemXxdz() {
        return itemXxdz;
    }

    public void setItemXxdz(String itemXxdz) {
        this.itemXxdz = itemXxdz;
    }
}
