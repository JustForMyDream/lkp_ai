 ...
 */
@Entity
@Table(name = "tlk_hdxxbm", schema = "lkp", catalog = "")
public class TlkHdxxbmEntity {
    private String parent;
    private Date lastmodified = new Date();
    private String formname="lkp/社区产品/活动管理/HDXXBM";
    ...
    private String formid = "11e6-bedc-91a1ef30-8401-4b9f5d257afc";
    ...
    @Basic
    @Column(name = "ITEM_USERBH", nullable = true, length = 200)
    public String getItemUserbh() {
        return itemUserbh;
    }

    public void setItemUserbh(String itemUserbh) {
        this.itemUserbh = itemUserbh;
    }
    ...
    @Basic
    @Column(name = "ITEM_PSDX", nullable = true, length = 200)
    public String getItemPsdx() {
        return itemPsdx;
    }

    public void setItemPsdx(String itemPsdx) {
        this.itemPsdx = itemPsdx;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkHdxxbmEntity that = (TlkHdxxbmEntity) o;
        ...
        if (itemUserbh != null ? !itemUserbh.equals(that.itemUserbh) : that.itemUserbh != null) return false;
        if (itemSysbh != null ? !itemSysbh.equals(that.itemSysbh) : that.itemSysbh != null) return false;
        ...
        if (itemPsdx != null ? !itemPsdx.equals(that.itemPsdx) : that.itemPsdx != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemUserbh != null ? itemUserbh.hashCode() : 0);
        result = 31 * result + (itemSysbh != null ? itemSysbh.hashCode() : 0);
        result = 31 * result + (itemName != null ? itemName.hashCode() : 0);
        result = 31 * result + (itemSex != null ? itemSex.hashCode() : 0);
        result = 31 * result + (itemLxfs != null ? itemLxfs.hashCode() : 0);
        result = 31 * result + (itemPsdx != null ? itemPsdx.hashCode() : 0);
        return result;
    }
    ...
    @Basic
    @Column(name = "ITEM_XQ")
    public String getItemXq() {
        return itemXq;
    }

    public void setItemXq(String itemXq) {
        this.itemXq = itemXq;
    }
