 ...
 */
@Entity
@Table(name = "tlk_mhdbmzd", schema = "lkp", catalog = "")
public class TlkMhdbmzdEntity {
    ...
    private String id;
    private String itemHdbmbh;
    private String itemBmzdmc;
    private String itemBmzdlx;
    private String itemSfbt;
    ...
    @Basic
    @Column(name = "ITEM_HDBMBH", nullable = true, length = 200)
    public String getItemHdbmbh() {
        return itemHdbmbh;
    }

    public void setItemHdbmbh(String itemHdbmbh) {
        this.itemHdbmbh = itemHdbmbh;
    }

    @Basic
    @Column(name = "ITEM_BMZDMC", nullable = true, length = 200)
    public String getItemBmzdmc() {
        return itemBmzdmc;
    }

    public void setItemBmzdmc(String itemBmzdmc) {
        this.itemBmzdmc = itemBmzdmc;
    }

    @Basic
    @Column(name = "ITEM_BMZDLX", nullable = true, length = 200)
    public String getItemBmzdlx() {
        return itemBmzdlx;
    }

    public void setItemBmzdlx(String itemBmzdlx) {
        this.itemBmzdlx = itemBmzdlx;
    }

    @Basic
    @Column(name = "ITEM_SFBT", nullable = true, length = 200)
    public String getItemSfbt() {
        return itemSfbt;
    }

    public void setItemSfbt(String itemSfbt) {
        this.itemSfbt = itemSfbt;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkMhdbmzdEntity that = (TlkMhdbmzdEntity) o;
        ...
        if (itemHdbmbh != null ? !itemHdbmbh.equals(that.itemHdbmbh) : that.itemHdbmbh != null) return false;
        if (itemBmzdmc != null ? !itemBmzdmc.equals(that.itemBmzdmc) : that.itemBmzdmc != null) return false;
        if (itemBmzdlx != null ? !itemBmzdlx.equals(that.itemBmzdlx) : that.itemBmzdlx != null) return false;
        if (itemSfbt != null ? !itemSfbt.equals(that.itemSfbt) : that.itemSfbt != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemHdbmbh != null ? itemHdbmbh.hashCode() : 0);
        result = 31 * result + (itemBmzdmc != null ? itemBmzdmc.hashCode() : 0);
        result = 31 * result + (itemBmzdlx != null ? itemBmzdlx.hashCode() : 0);
        result = 31 * result + (itemSfbt != null ? itemSfbt.hashCode() : 0);
        return result;
    }
}
