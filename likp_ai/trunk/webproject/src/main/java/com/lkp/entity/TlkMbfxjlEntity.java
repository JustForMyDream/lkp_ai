 ...
 */
@Entity
@Table(name = "tlk_mbfxjl", schema = "lkp", catalog = "")
public class TlkMbfxjlEntity {
    ...
    private String itemMbjlbh;
    private Date itemSharetime;
    private BigDecimal itemSharenum;
    private String id;
    ...
    @Basic
    @Column(name = "ITEM_MBJLBH")
    public String getItemMbjlbh() {
        return itemMbjlbh;
    }

    public void setItemMbjlbh(String itemMbjlbh) {
        this.itemMbjlbh = itemMbjlbh;
    }

    @Basic
    @Column(name = "ITEM_SHARETIME")
    public Date getItemSharetime() {
        return itemSharetime;
    }

    public void setItemSharetime(Date itemSharetime) {
        this.itemSharetime = itemSharetime;
    }

    @Basic
    @Column(name = "ITEM_SHARENUM")
    public BigDecimal getItemSharenum() {
        return itemSharenum;
    }

    public void setItemSharenum(BigDecimal itemSharenum) {
        this.itemSharenum = itemSharenum;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkMbfxjlEntity that = (TlkMbfxjlEntity) o;
        ...
        if (prevaudituser != null ? !prevaudituser.equals(that.prevaudituser) : that.prevaudituser != null)
            return false;
        if (itemMbjlbh != null ? !itemMbjlbh.equals(that.itemMbjlbh) : that.itemMbjlbh != null) return false;
        if (itemSharetime != null ? !itemSharetime.equals(that.itemSharetime) : that.itemSharetime != null)
            return false;
        if (itemSharenum != null ? !itemSharenum.equals(that.itemSharenum) : that.itemSharenum != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemMbjlbh != null ? itemMbjlbh.hashCode() : 0);
        result = 31 * result + (itemSharetime != null ? itemSharetime.hashCode() : 0);
        result = 31 * result + (itemSharenum != null ? itemSharenum.hashCode() : 0);
