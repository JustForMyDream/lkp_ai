 ...
 */
@Entity
@Table(name = "tlk_hzhbgl", schema = "lkp", catalog = "")
public class TlkHzhbglEntity {
    ...
    @Basic
    @Column(name = "ITEM_HZHBMC")
    public String getItemHzhbmc() {
        return itemHzhbmc;
    }

    public void setItemHzhbmc(String itemHzhbmc) {
        this.itemHzhbmc = itemHzhbmc;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkHzhbglEntity that = (TlkHzhbglEntity) o;
        ...
        if (itemHzhbmc != null ? !itemHzhbmc.equals(that.itemHzhbmc) : that.itemHzhbmc != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemHzhbmc != null ? itemHzhbmc.hashCode() : 0);
