 ...
 */
@Entity
@Table(name = "tlk_gzhf", schema = "lkp", catalog = "")
public class TlkGzhfEntity {
    ...
    @Basic
    @Column(name = "ITEM_HFNR")
    public String getItemHfnr() {
        return itemHfnr;
    }

    public void setItemHfnr(String itemHfnr) {
        this.itemHfnr = itemHfnr;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkGzhfEntity that = (TlkGzhfEntity) o;
        ...
        if (itemHfnr != null ? !itemHfnr.equals(that.itemHfnr) : that.itemHfnr != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemHfnr != null ? itemHfnr.hashCode() : 0);
        return result;
    }
}
