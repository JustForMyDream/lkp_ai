 ...
 */
@Entity
@Table(name = "tlk_productcopy", schema = "lkp", catalog = "")
public class TlkProductcopyEntity {
    ...
    private String itemZsyj;
    private String itemShzt;
    private String itemHdbh;
    private String itemSys;
    private String id;
    private Set<TlkProductshowcopyEntity> tlkProductshowcopyEntities;
    private Set<TlkCpfwxqcopyEntity> tlkCpfwxqcopyEntities;
    ...
    @Basic
    @Column(name = "ITEM_ZSYJ")
    public String getItemZsyj() {
        return itemZsyj;
    }

    public void setItemZsyj(String itemZsyj) {
    ...
    @OneToMany(mappedBy = "tlkProductcopyEntity",targetEntity = TlkProductshowcopyEntity.class)
    @OrderBy("itemShoworder")
    public Set<TlkProductshowcopyEntity> getTlkProductshowcopyEntities() {
        return tlkProductshowcopyEntities;
    }

    public void setTlkProductshowcopyEntities(Set<TlkProductshowcopyEntity> tlkProductshowcopyEntities) {
        this.tlkProductshowcopyEntities = tlkProductshowcopyEntities;
    }

    @OneToMany
    @JoinColumn(name = "PARENT",foreignKey = @ForeignKey(name = "null"))
    public Set<TlkCpfwxqcopyEntity> getTlkCpfwxqcopyEntitys() {
        return tlkCpfwxqcopyEntities;
    }

    public void setTlkCpfwxqcopyEntitys(Set<TlkCpfwxqcopyEntity> tlkCpfwxqcopyEntitys) {
        this.tlkCpfwxqcopyEntities = tlkCpfwxqcopyEntities;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkProductcopyEntity that = (TlkProductcopyEntity) o;
        ...
        if (itemCpzti != null ? !itemCpzti.equals(that.itemCpzti) : that.itemCpzti != null) return false;
        if (itemZsyj != null ? !itemZsyj.equals(that.itemZsyj) : that.itemZsyj != null) return false;
        if (itemShzt != null ? !itemShzt.equals(that.itemShzt) : that.itemShzt != null) return false;
        if (itemHdbh != null ? !itemHdbh.equals(that.itemHdbh) : that.itemHdbh != null) return false;
        if (itemSys != null ? !itemSys.equals(that.itemSys) : that.itemSys != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemCpzti != null ? itemCpzti.hashCode() : 0);
        result = 31 * result + (itemZsyj != null ? itemZsyj.hashCode() : 0);
        result = 31 * result + (itemShzt != null ? itemShzt.hashCode() : 0);
        result = 31 * result + (itemHdbh != null ? itemHdbh.hashCode() : 0);
        result = 31 * result + (itemSys != null ? itemSys.hashCode() : 0);
