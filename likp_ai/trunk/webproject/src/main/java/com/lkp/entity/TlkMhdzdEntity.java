 ...
 */
@Entity
@Table(name = "tlk_mhdzd", schema = "lkp", catalog = "")
public class TlkMhdzdEntity {
    ...
    private String itemHdzdmc;
    private String itemHdzdnr;
    ...
    @Basic
    @Column(name = "ITEM_HDZDMC", nullable = true, length = 200)
    public String getItemHdzdmc() {
        return itemHdzdmc;
    }

    public void setItemHdzdmc(String itemHdzdmc) {
        this.itemHdzdmc = itemHdzdmc;
    }

    @Basic
    @Column(name = "ITEM_HDZDNR", nullable = true, length = 200)
    public String getItemHdzdnr() {
        return itemHdzdnr;
    }

    public void setItemHdzdnr(String itemHdzdnr) {
        this.itemHdzdnr = itemHdzdnr;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkMhdzdEntity that = (TlkMhdzdEntity) o;
        ...
        if (itemHdzdmc != null ? !itemHdzdmc.equals(that.itemHdzdmc) : that.itemHdzdmc != null) return false;
        if (itemHdzdnr != null ? !itemHdzdnr.equals(that.itemHdzdnr) : that.itemHdzdnr != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemHdzdmc != null ? itemHdzdmc.hashCode() : 0);
        result = 31 * result + (itemHdzdnr != null ? itemHdzdnr.hashCode() : 0);
        return result;
    }
}
