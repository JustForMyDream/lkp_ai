 ...
 */
@Entity
@Table(name = "tlk_productshowpiccopy", schema = "lkp", catalog = "")
@Access(AccessType.PROPERTY)
public class TlkProductshowpiccopyEntity {
    ...
    private TlkProductshowcopyEntity tlkProductshowcopyEntity;

    @ManyToOne(fetch = FetchType.LAZY,targetEntity = TlkProductshowcopyEntity.class)
    @JoinColumn(name = "PARENT",foreignKey = @ForeignKey(name = "null"))
    public TlkProductshowcopyEntity getTlkProductshowcopyEntity() {
        return tlkProductshowcopyEntity;
    }

    public void setTlkProductshowcopyEntity(TlkProductshowcopyEntity tlkProductshowcopyEntity) {
        this.tlkProductshowcopyEntity = tlkProductshowcopyEntity;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkProductshowpiccopyEntity that = (TlkProductshowpiccopyEntity) o;
        ...
        if (itemDescript != null ? !itemDescript.equals(that.itemDescript) : that.itemDescript != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemDescript != null ? itemDescript.hashCode() : 0);
        return result;
    }
}
