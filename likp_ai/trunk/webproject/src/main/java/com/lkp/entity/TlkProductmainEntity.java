 ...
 */
@Entity
@Table(name = "tlk_productmain", schema = "lkp", catalog = "")
public class TlkProductmainEntity implements Serializable {
    ...
    private String itemCpfm;
    private String itemState;
    private String id;
    private String itemZtbh;
    private Set<TlkProductEntity> productEntitySet;
    private String itemZtms;

    @OneToMany
    @JoinColumn(name="ITEM_CPZTI" ,referencedColumnName = "ITEM_ZTBH",foreignKey = @ForeignKey(name = "null"))
    public Set<TlkProductEntity> getProductEntitySet() {
        return productEntitySet;
    }

    public void setProductEntitySet(Set<TlkProductEntity> productEntitySet) {
    ...
    @Basic
    @Column(name = "ITEM_CPFM")
    public String getItemCpfm() {
        return itemCpfm;
    }

    public void setItemCpfm(String itemCpfm) {
        this.itemCpfm = itemCpfm;
    }
...
//    @OneToMany(mappedBy = "tlkProductshowEntity",targetEntity = TlkProductshowpicEntity.class)
//    @OrderBy("itemOrder")
    @Basic
    @Column(name = "ITEM_ZTBH")
    public String getItemZtbh() {
        return itemZtbh;
    }

    public void setItemZtbh(String itemZtbh) {
        this.itemZtbh = itemZtbh;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkProductmainEntity that = (TlkProductmainEntity) o;
        ...
        if (itemCpfm != null ? !itemCpfm.equals(that.itemCpfm) : that.itemCpfm != null) return false;
        if (itemState != null ? !itemState.equals(that.itemState) : that.itemState != null) return false;
        if (id != null ? !id.equals(that.id) : that.id != null) return false;
        if (itemZtbh != null ? !itemZtbh.equals(that.itemZtbh) : that.itemZtbh != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemCpfm != null ? itemCpfm.hashCode() : 0);
        result = 31 * result + (itemState != null ? itemState.hashCode() : 0);
        result = 31 * result + (id != null ? id.hashCode() : 0);
        result = 31 * result + (itemZtbh != null ? itemZtbh.hashCode() : 0);
        return result;
    }

    @Basic
    @Column(name = "ITEM_ZTMS")
    public String getItemZtms() {
        return itemZtms;
    }

    public void setItemZtms(String itemZtms) {
        this.itemZtms = itemZtms;
    }
}
