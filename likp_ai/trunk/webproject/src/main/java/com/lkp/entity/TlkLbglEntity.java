 ...
 */
@Entity
@Table(name = "tlk_lbgl", schema = "lkp", catalog = "")
public class TlkLbglEntity {
    ...
    private String id;
    private String itemLblx;
    private String itemLbbh;
    private String itemLbtp;
    private BigDecimal itemPxxh;
    private String itemTplj;
    ...
    @Basic
    @Column(name = "ITEM_LBLX")
    public String getItemLblx() {
        return itemLblx;
    }

    public void setItemLblx(String itemLblx) {
        this.itemLblx = itemLblx;
    }

    @Basic
    @Column(name = "ITEM_LBBH")
    public String getItemLbbh() {
        return itemLbbh;
    }

    public void setItemLbbh(String itemLbbh) {
        this.itemLbbh = itemLbbh;
    }

    @Basic
    @Column(name = "ITEM_LBTP")
    public String getItemLbtp() {
        return itemLbtp;
    }

    public void setItemLbtp(String itemLbtp) {
        this.itemLbtp = itemLbtp;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkLbglEntity that = (TlkLbglEntity) o;
        ...
        if (itemLblx != null ? !itemLblx.equals(that.itemLblx) : that.itemLblx != null) return false;
        if (itemLbbh != null ? !itemLbbh.equals(that.itemLbbh) : that.itemLbbh != null) return false;
        if (itemLbtp != null ? !itemLbtp.equals(that.itemLbtp) : that.itemLbtp != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemLblx != null ? itemLblx.hashCode() : 0);
        result = 31 * result + (itemLbbh != null ? itemLbbh.hashCode() : 0);
        result = 31 * result + (itemLbtp != null ? itemLbtp.hashCode() : 0);
        return result;
    }

    @Basic
    @Column(name = "ITEM_PXXH")
    public BigDecimal getItemPxxh() {
        return itemPxxh;
    }

    public void setItemPxxh(BigDecimal itemPxxh) {
        this.itemPxxh = itemPxxh;
    }

    @Basic
    @Column(name = "ITEM_TPLJ")
    public String getItemTplj() {
        return itemTplj;
    }

    public void setItemTplj(String itemTplj) {
        this.itemTplj = itemTplj;
    }
}
