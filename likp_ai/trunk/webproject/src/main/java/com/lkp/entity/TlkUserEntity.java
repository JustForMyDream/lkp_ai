 ...
 */
@Entity
@Table(name = "tlk_user", schema = "lkp", catalog = "")
public class TlkUserEntity implements Serializable{
    private String parent;
    private Date lastmodified = new Date();
    private String formname = "lkp/社区产品/用户管理/User";
    ...
    private String formid = "11e6-9462-a067510d-ad8b-11472dfbd6fd";
    ...
    private Set<TlkUserwechatinfoEntity> wechatInfo;
    private String itemIsguide;
    ...
    @OneToMany(mappedBy = "uwitemUserid",targetEntity = TlkUserwechatinfoEntity.class,fetch = FetchType.LAZY)
    public Set<TlkUserwechatinfoEntity> getWechatInfo() {
        return wechatInfo;
    }

    public void setWechatInfo(Set<TlkUserwechatinfoEntity> wechatInfo) {
    ...
    public boolean equals(Object o) {
        ...
        TlkUserEntity that = (TlkUserEntity) o;
    ...
    @Basic
    @Column(name = "ITEM_ISGUIDE")
    public String getItemIsguide() {
        return itemIsguide;
    }

    public void setItemIsguide(String itemIsguide) {
        this.itemIsguide = itemIsguide;
    }
}
