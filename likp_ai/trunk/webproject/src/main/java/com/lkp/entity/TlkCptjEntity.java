 ...
 */
@Entity
@Table(name = "tlk_cptj", schema = "lkp", catalog = "")
public class TlkCptjEntity {
    ...
    public String getItemZsxh() {
        return itemZsxh;
    }

    public void setItemZsxh(String itemZsxh) {
    ...
    public boolean equals(Object o) {
        ...
        TlkCptjEntity that = (TlkCptjEntity) o;
    ...
    @Basic
    @Column(name = "ITEM_CPWLTP")
    public String getItemCpwltp() {
        return itemCpwltp;
    }

    public void setItemCpwltp(String itemCpwltp) {
        this.itemCpwltp = itemCpwltp;
    }
}
