 ...
 */
@Entity
@Table(name = "tlk_user_collection", schema = "lkp", catalog = "")
public class TlkUserCollectionEntity {
    ...
    private String itemZpmc;
    private String itemZplx;
    private String id;

    @Basic
    @Column(name = "ITEM_ZPMC")
    public String getItemZpmc() {
        return itemZpmc;
    }

    public void setItemZpmc(String itemZpmc) {
        this.itemZpmc = itemZpmc;
    }
    ...
    @Basic
    @Column(name = "ITEM_ZPLX")
    public String getItemZplx() {
        return itemZplx;
    }

    public void setItemZplx(String itemZplx) {
        this.itemZplx = itemZplx;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkUserCollectionEntity that = (TlkUserCollectionEntity) o;
        ...
        if (itemZplx != null ? !itemZplx.equals(that.itemZplx) : that.itemZplx != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (itemZplx != null ? itemZplx.hashCode() : 0);
