 ...
 *
 * 用户微信信息关联实体
 * 与微信信息尸体一对一关系 关联字段 ITEM_OPENID
 * 与用户表多对一关系 关联字段  ITEM_USERID
 */
@Entity
@javax.persistence.Table(name = "tlk_userwechatinfo", schema = "lkp", catalog = "")
@Access(AccessType.PROPERTY)
public class TlkUserwechatinfoEntity {
    ...
    private String formname = "lkp/社区产品/用户管理/userwechatinfo";
    ...
    private String formid = "11e6-9465-2e3f31e2-ad8b-11472dfbd6fd";
    ...
    @Basic
    @javax.persistence.Column(name = "ITEM_USERID", nullable = true, length = 200)
    public String getItemUserid() {
        return itemUserid;
    }*/

    private TlkUserEntity uwitemUserid;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "ITEM_USERID",referencedColumnName = "ITEM_BH",foreignKey = @ForeignKey(name = "null"))
    public TlkUserEntity getUwitemUserid() {
        return uwitemUserid;
    }

    public void setUwitemUserid(TlkUserEntity itemUserid) {
        this.uwitemUserid = itemUserid;
    }
    ...
    public boolean equals(Object o) {
        ...
        TlkUserwechatinfoEntity that = (TlkUserwechatinfoEntity) o;
