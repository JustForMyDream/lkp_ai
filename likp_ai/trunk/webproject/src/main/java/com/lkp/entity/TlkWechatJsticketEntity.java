 ...
 */
@Entity
@javax.persistence.Table(name = "tlk_wechat_jsticket", schema = "lkp", catalog = "")
@Access(AccessType.PROPERTY)
public class TlkWechatJsticketEntity {
    ...
    @Basic
    @javax.persistence.Column(name = "ITEM_TICKET", nullable = true, length = 200)
    ...
    public boolean equals(Object o) {
        ...
        TlkWechatJsticketEntity that = (TlkWechatJsticketEntity) o;
