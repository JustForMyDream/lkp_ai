 ...
 */
@Entity
@Table(name = "tlk_pt_user_wxbd", schema = "lkp", catalog = "")
public class TlkPtUserWxbdEntity {
    ...
    /*用户角色 YHJS (1 是客服)*/
    @Basic
    @Column(name = "ITEM_YHJS")
    public String getItemYhjs() {
        return itemYhjs;
    }

    public void setItemYhjs(String itemYhjs) {
        this.itemYhjs = itemYhjs;
    }
    /*用户姓名 name*/
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        TlkPtUserWxbdEntity that = (TlkPtUserWxbdEntity) o;
        ...
        if (prevaudituser != null ? !prevaudituser.equals(that.prevaudituser) : that.prevaudituser != null)
            return false;
        if (itemYhjs != null ? !itemYhjs.equals(that.itemYhjs) : that.itemYhjs != null) return false;
        ...
        if (itemNc != null ? !itemNc.equals(that.itemNc) : that.itemNc != null) return false;
