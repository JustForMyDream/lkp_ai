...
<div id="coverChoose" class="mui-page">
    ...
    <div class="mui-page-content" style="background-color: #ECECEC">
        ...
        <div class="add-content">
            <button class="item-add" type="button"><span class="mui-icon mui-icon-plusempty"></span><br>点击选择图片</button>
        </div>
    </div>
</div>
        ...
        <div class="mui-scroll-wrapper">
            <div class="mui-scroll">
                <ul id="musicList" class="mui-table-view">
                    ...
                    <li class="mui-table-view-cell">
                        <a class="selected"
                           data-music="http://www.91lkp.com:80/lkpai_test/bgm/青春快乐(伴奏)__.mp3">青春快乐(伴奏)</a>
                    </li>
                    <li class="mui-table-view-cell">
                    ...
                    <li class="mui-table-view-cell">
                        <a data-music="http://www.91lkp.com:80/lkpai_test/bgm/邓丽君 -  恭喜你.mp3">邓丽君 -  恭喜你</a>
                    </li>
                    <li class="mui-table-view-cell">
                        <a data-music="http://www.91lkp.com:80/lkpai_test/bgm/又是一个好新年.mp3">又是一个好新年.mp3</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    function ImgObj(id, type, src, targetId,des) {
        ...
        this.toHTML = function () {
             var str = "<div class=\"item\" id=\""+this.id+"\" data-target=" + this.toString() + ">"+
                "<div class=\"itemInnerWrapper\">";
            str+=("<div class='img-warp'><img class=\"img\" src=\""+this.src+"\"/></div><button class=\"removeItem\" style='z-index: 996'><span class=\"mui-icon mui-icon-closeempty\"></span> </button>");
            if(this.des!=null) {
...
/*    var id = "297e9e795980e376015981044554000a";*/
    ...
    var wxready=false,jqueryready=false;
    var yingji = $.yingji();
    var MaxImageNum=20;
...
/*    if (orderid != '') {
    ...
    function uploadImg(i) {
        ...
        if (i < list.length) {
            var obj=list[i];
            new ImgObj(obj.id,obj.type, obj.src, obj.targetId,obj.des).uploadImg();
        }else{
            uploadYingji();
        }
    }
    ...
    function uploadYingji(){
        ...
        if (id != "" && id != null) {
            data = {
                id: id,
                title: $("#coverChoose .title input").val(),
        ...
        xhr.open("post", "../userPort/yingji/newCreate", true);
            ...
            if (xhr.readyState == 4) {
                if (xhr.status >= 200 && xhr.status < 400) {
                    ...
                    if (o.errorCode == 400) {
                        ...
                        mui.toast("影集创建成功!");
                        setTimeout(function () {
                            window.location.href = "newYingji?id=" + o.id;
                        }, 2000);
                    }
                    uploadimg_I=0;
                } else {
