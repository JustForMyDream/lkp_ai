...
<div id="coverChoose" class="mui-page">
    <div class="mui-navbar-inner mui-bar mui-bar-nav" style="background-color: #303030;">
        ...
        <h1 id="number" class="mui-center mui-title" style="right: 220px;left: -47px;"><p style='color: white;'>已选<span style='color:#FDE23D;font-size: 20px '>0</span>张精修</p></h1>
    </div>
...
//                }
            ...
            mui.toast("精修图片上传成功");
            $.ajax({
                url:"../PICTUREPAY/saveTrimPicture",
                type:"get",
                data:data,
                dataType:"json",
                success:function (data) {
    ...
    function getCurrentPictureNumbers() {
        ...
        $("#number p").remove();
        $("#number").append("<p style='color: white;'>已选<span style='color:#FDE23D;font-size: 20px '>" + numbers + "</span>精修张</p>");
    }
