        ...
        <div class="phone">
            <div class="phone-content">
                ...
                <div class="phone-body">
                    ...
                    <div class="des">
                        <textarea rows="3" placeholder="请输入描述" style="max-width: 100% ;max-height: 37%"></textarea>
                    </div>
                    <div class="pic"></div>
                    <div id="mess" style="    position: absolute; bottom: 4px;left: 28.5px;visibility: visible;margin-left: 39px;">滚动查看页面其余内容</div>
                </div>
            </div>
        </div>
        <div class="img_music">
            <div class="btn-switch">
                <div>
                    <a href="#pics" class="showpic" title="图片设置" >
                        <img id="showpic" style="margin-left: 12px;" width="30px" src="<%=basePath%>/image/tupianshezhi-1.png">
                    </a>
                    <div class="item-head" style="color: gray;font-size: 12px;">
                        图片设置
                    </div>
                </div>
                <div>
                    <a  href="#musics" class="showimg" title="音乐选择">
                        <img id="showmusic" style="margin-left: 12px; " width="30px" src="<%=basePath%>/image/yinyuesehzhi.png">
                    </a>
                    <div class="item-head" style=" color: gray;font-size: 12px;">
                        音乐选择
                    </div>
...
<script>
    ...
    $(function(){
        ...
        var newimage1 = $("#showpic").attr('src');
        var oldimage2 = $("#showmusic").attr('src');
        oldimage1.src = "<%=basePath%>/image/tupianshezhi.png";
        newimage2.src = "<%=basePath%>/image/yinyueshezhi-1.png"
        $("#showmusic").on("click" ,function (e) {
            $("#showmusic").attr('src',newimage2.src);
            $("#showpic").attr('src',oldimage1.src);
        })
        $("#showpic").on("click" ,function (e) {
            $("#showpic").attr('src',newimage1);
                        ...
                        success:function(data){
                            if(data.result == "success"){
                                alert("创建影集成功");
                                   ...
                                   if(code.getElementsByTagName("img").length==0){
                                       console.log("1111111");
                                       var qrcode = new QRCode(document.getElementById("qrcode"), {
                                           width: 160,//设置宽高
                                           height: 160
                                       });
                                       qrcode.makeCode("http://www.91lkp.com/lkpai_test/YINGJI/newYingji?id="+data.id);
                                       $("#tishi").append("<p>微信扫码即可在手机上预览影集播放效果</p>")
                                   }
                                   else{
                                       return;
                                   }
