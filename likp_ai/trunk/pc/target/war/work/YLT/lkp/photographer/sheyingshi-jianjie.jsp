            ...
            success: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var pjnr = data[0].itemPjnr;
                        var pjxj = data[0].itemPjxj;
                        var pjsj = data[0].itemPjsj;
                        $(".time").text(new Date(pjsj).format("yyyy年MM月dd日") + "");
                        $(".leirong").text(pjnr);
                          (pjxj);
                        for(var i = 0;i<pjxj;i++)
                        {
                            $(".pjxj").append('<img class="wujiaoxing" src="../images/sheyingshi/wujiaoxing.png">');
                        }
                        $mask.hide();
                    }
                });
